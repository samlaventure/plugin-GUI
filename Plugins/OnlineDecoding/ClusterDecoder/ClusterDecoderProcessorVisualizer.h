...
#ifndef CLUSTERDECODERPROCESSORVISUALIZER_H_INCLUDED
#define CLUSTERDECODERPROCESSORVISUALIZER_H_INCLUDED

#include <VisualizerEditorHeaders.h>
#include <AllLookAndFeels.h>

#include "ClusterDecoderProcessor.h"
#include "ClusterDecoderProcessorVisualizerContentComponent.h"
...
*/
class ClusterDecoderProcessorVisualizer : public Visualizer
{
public:
    /** The class constructor, used to initialize any members. */
    ClusterDecoderProcessorVisualizer (ClusterDecoderProcessor* processor);

    /** The class destructor, used to deallocate memory */
    ~ClusterDecoderProcessorVisualizer();
...
private:
    ClusterDecoderProcessor* processor;
    ...
    ClusterDecoderProcessorVisualizerContentComponent content;
    //
    //ScopedPointer<LookAndFeel> m_contentLookAndFeel;

    // ========================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ClusterDecoderProcessorVisualizer);
};


#endif // CLUSTERDECODERPROCESSORVISUALIZER_H_INCLUDED
