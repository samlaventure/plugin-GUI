...
#ifndef POSITIONDECODERPROCESSORVISUALIZER_H_INCLUDED
#define POSITIONDECODERPROCESSORVISUALIZER_H_INCLUDED

#include <VisualizerEditorHeaders.h>
#include <AllLookAndFeels.h>

#include "PositionDecoderProcessor.h"
#include "PositionDecoderProcessorVisualizerContentComponent.h"
...
*/
class PositionDecoderProcessorVisualizer : public Visualizer
{
public:
    /** The class constructor, used to initialize any members. */
    PositionDecoderProcessorVisualizer (PositionDecoderProcessor* processor);

    /** The class destructor, used to deallocate memory */
    ~PositionDecoderProcessorVisualizer();
...
private:
    PositionDecoderProcessor* processor;
    ...
    PositionDecoderProcessorVisualizerContentComponent content;
    //
    //ScopedPointer<LookAndFeel> m_contentLookAndFeel;

    // ========================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PositionDecoderProcessorVisualizer);
};


#endif // POSITIONDECODERPROCESSORVISUALIZER_H_INCLUDED
