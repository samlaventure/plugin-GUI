...
#ifndef SLEEPSCORERPROCESSORVISUALIZER_H_INCLUDED
#define SLEEPSCORERPROCESSORVISUALIZER_H_INCLUDED

#include <VisualizerEditorHeaders.h>
#include <AllLookAndFeels.h>

#include "SleepScorerProcessor.h"
#include "SleepScorerProcessorVisualizerContentComponent.h"
...
*/
class SleepScorerProcessorVisualizer : public Visualizer
{
public:
    /** The class constructor, used to initialize any members. */
    SleepScorerProcessorVisualizer (SleepScorerProcessor* processor);

    /** The class destructor, used to deallocate memory */
    ~SleepScorerProcessorVisualizer();
...
private:
    SleepScorerProcessor* processor;
    ...
    SleepScorerProcessorVisualizerContentComponent content;
    //
    //ScopedPointer<LookAndFeel> m_contentLookAndFeel;

    // ========================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SleepScorerProcessorVisualizer);
};


#endif // SLEEPSCORERPROCESSORVISUALIZER_H_INCLUDED
