...
#ifndef SLEEPSCORERPROCESSOREDITOR_H_INCLUDED
#define SLEEPSCORERPROCESSOREDITOR_H_INCLUDED
...
*/
class SleepScorerProcessorEditor : public VisualizerEditor, public TextEditorListener
{
public:
    /** The class constructor, used to initialize any members. */
    SleepScorerProcessorEditor (GenericProcessor* parentNode, bool useDefaultParameterEditors);

    /** The class destructor, used to deallocate memory */
    ~SleepScorerProcessorEditor();
...
private:
    ...
    SleepScorerProcessorContentComponent content;
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SleepScorerProcessorEditor);
};

#endif // SLEEPSCORERPROCESSOREDITOR_H_INCLUDED
