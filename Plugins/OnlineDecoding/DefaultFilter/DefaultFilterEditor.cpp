...
DefaultFilterEditor::DefaultFilterEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors=true)
...
void DefaultFilterEditor::setDefaults(double lowCut, double highCut)
{
...
void DefaultFilterEditor::resetToSavedText()
{
...
void DefaultFilterEditor::labelTextChanged(Label* label)
{
    DefaultFilterProcessor* fn = (DefaultFilterProcessor*) getProcessor();
...
void DefaultFilterEditor::channelChanged (int channel, bool /*newState*/)
{
    DefaultFilterProcessor* fn = (DefaultFilterProcessor*) getProcessor();
...
void DefaultFilterEditor::buttonEvent(Button* button)
{
...
void DefaultFilterEditor::saveCustomParameters(XmlElement* xml)
{

    xml->setAttribute("Type", "DefaultFilterEditor");
...
void DefaultFilterEditor::loadCustomParameters(XmlElement* xml)
{
